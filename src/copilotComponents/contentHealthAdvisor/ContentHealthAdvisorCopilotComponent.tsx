 ...
 */
export default class ContentHealthAdvisorCopilotComponent extends BaseCopilotComponent<IContentHealthAdvisorCopilotComponentProperties> {
  ...
  protected render(): void {
    const props: IContentHealthAdvisorProps = {
